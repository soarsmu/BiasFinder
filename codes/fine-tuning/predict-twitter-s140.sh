...
python predict.py --mutation-tool biasfinder --bias-type gender --task twitter_s140 --model albert-base-v2 --mutant twitter_s140
python predict.py --mutation-tool biasfinder --bias-type gender --task twitter_s140 --model microsoft/mpnet-base --mutant twitter_s140
# python predict.py --mutation-tool biasfinder --bias-type gender --task twitter_s140 --model microsoft/deberta-base --mutant twitter_s140
python predict.py --mutation-tool biasfinder --bias-type gender --task twitter_s140 --model facebook/muppet-roberta-base --mutant twitter_s140
python predict.py --mutation-tool biasfinder --bias-type gender --task twitter_s140 --model google/electra-base-generator --mutant twitter_s140
