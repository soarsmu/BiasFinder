...
def main():
    ...
    ## Required parameters
    parser.add_argument("--fine_tune_data_1_dir",
                        default=None,
                        type=str,
                        required=True,
    ...
    parser.add_argument("--template_size",
                        ...
                        type=int,
                        required=True,
                        help="The number of mutant generated from a template. It must be the same for male and female")   
    ...
    with open(os.path.join(args.output_dir, "fped-fned-discordant-pairs.txt"),"w") as f:
        ...
        f.write("Number of discordant pairs: " + str(dp) + "\n")
