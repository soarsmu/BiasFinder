...
if len(a) > 0:
    ...
    preparedOccData.to_csv('./occ-result.csv', index=False)
# if len(b) > 0:
...
#     headers = ['0', '1', 'mutant', 'template', 'original', 'age', 'name']
#     preparedAgeDataTemp = [outputDataAge['sentiment'], outputDataAge['mutant'], outputDataAge['mutant'], outputDataAge['template'], outputDataAge['ori'], outputDataAge['age'], outputDataAge['name']]
